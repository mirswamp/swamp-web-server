...
return [
    ...
    */
    ...
    'store' => env('APP_STORE', '/swamp/store/'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This parameter is used to return 200 for all 200 series status codes.
    |
    */

    'simple_status_codes' => env('APP_SIMPLE_STATUS_CODES', false),
